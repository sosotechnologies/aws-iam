...
parameters:
  provisioningMode: efs-ap
  fileSystemId: fs-0998691786f1fee6b  # Replace with your EFS FileSystem ID
  directoryPerms: "755"
  gidRangeStart: "1000"
  gidRangeEnd: "2000"
  uid: "1001"
...
YAML
  ...
  depends_on = [
    module.efs.efs        # Ensure EFS file system is created
  ]
}
